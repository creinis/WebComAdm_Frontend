...
const ManageCrew = () => {
  ...
  useEffect(() => {
    const fetchAdmins = async () => {
      try {
        const response = await axios.get('http://web-com-admin-backend.vercel.app/api/admins/admins');
  ...
  const handleEditAdmin = async (updatedAdminData) => {
    try {
      await axios.put(`http://web-com-admin-backend.vercel.app/api/admins/admins/${selectedAdmin._id}`, updatedAdminData);
  ...
  const handleDeleteAdmin = async () => {
    try {
      await axios.delete(`http://web-com-admin-backend.vercel.app/api/admins/admins/${selectedAdmin._id}`);
